...
<body>
	...
	<div class="container-fluid">
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<%
				List<Usuario> usuarios = (List<Usuario>) request.getAttribute("usuarios"); // Obtiene la lista de usuarios
				if (usuarios != null && !usuarios.isEmpty()) { // Verifica que la lista no esté vacía
				...
				%>
				<tr>
					<td colspan="6" class="text-center">No hay usuarios
						disponibles.</td>
